 ...
 */
package com.mycompany.proyectocc1.empleadosGUI;
import com.mycompany.proyectocc1.empleadosBL.empleadosBL;
import com.mycompany.proyectocc1.empleadosDAL.conexion;
...
public class frmEmpleados extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String strSentenciaInsert = String.format("INSERT INTO empleados "
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String strSentenciaInsert = String.format("UPDATE empleados SET nombre = '%s', correo ='%s' WHERE id = %d "
                , oEmpleados.getNombre(), oEmpleados.getCorreo(), oEmpleados.getID());
        objConexion.ejecutarSentenciaSQL(strSentenciaInsert);
    ...
    public void mostrarDatos()
    {
        ...
        try {
            ...
            while(resultado.next()){
                ...
                System.out.print(resultado.getString("correo"));
